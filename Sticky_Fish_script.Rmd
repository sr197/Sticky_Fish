...
#standardized <- lm.beta(fit)
        fit_depth <- gam(as.formula(paste(specnames[i],"~ 1 + depth")), data=fall)
          fit_bt <- gam(as.formula(paste(specnames[i],"~ bottemp")), data=fall)
           fit_ssal <- gam(as.formula(paste(specnames[i],"~ surfsalin")), data=fall)
         fit_sed <- gam(as.formula(paste(specnames[i],"~ SEDIMENT")), data=fall)
         fit_bsal <- gam(as.formula(paste(specnames[i],"~ botsalin")), data=fall)
         fit_sst <- gam(as.formula(paste(specnames[i],"~ surftemp")), data=fall) 
...
#standardized <- lm.beta(fit)
        fit_depth <- gam(as.formula(paste(specnames[i],"~ 1 + depth")), data=spring)
          fit_bt <- gam(as.formula(paste(specnames[i],"~ bottemp")), data=spring)
           fit_ssal <- gam(as.formula(paste(specnames[i],"~ surfsalin")), data=spring)
         fit_sed <- gam(as.formula(paste(specnames[i],"~ SEDIMENT")), data=spring)
         fit_bsal <- gam(as.formula(paste(specnames[i],"~ botsalin")), data=spring)
         fit_sst <- gam(as.formula(paste(specnames[i],"~ surftemp")), data=spring) 
        dev.depth <- summary(fit_depth)$dev.expl
        dev.bt <- summary(fit_bt)$dev.expl
        dev.ssal <- summary(fit_ssal)$dev.expl
        dev.sst <- summary(fit_sst)$dev.expl
