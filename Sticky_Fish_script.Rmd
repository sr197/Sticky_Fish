...
#ocean_adapt$haulid1 <- as.numeric(as.integer(ocean_adapt$haulid1))
...
Select species based on CPUE in first five and last five years 
```{r}
load("neus_Survdat.RData")
load("neus_SVSPP.RData")
...
```{r}
#Ive gone in and made a cleaned up the supplemental tables for publication. They are the same as fall_dev_dist_spec, but with newer headings etc. We can make the figures from that. 
